...
public class MattressesShopByUserPage {

	public WebDriver driver;
	private ReusableMethods method;

	/************ MATTRESS SHOP BY USER PAGE WEB ELEMENTS ************/

	@FindBy(linkText = "MATTRESS FOR YOU")
	public WebElement myselfText;

	@FindBy(linkText = "MATTRESS FOR KIDS")
	public WebElement forKidsText;

	@FindBy(linkText = "MATTRESS FOR ELDERS")
	public WebElement forEldersText;

	/************ PARAMATERIZED CONSTRUCTOR ************/

	public MattressesShopByUserPage(WebDriver driver) {
		if (driver == null) {
	...
	/************ MATTRESS SHOP BY USER PAGE METHODS ************/
